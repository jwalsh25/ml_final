...
```{r}
decomp1 <- decompose(ts(totals$TotalKg, frequency = 10), type = "additive")
plot(decomp1)
```
...
It looks like we see a correlation through the first 3-4 lags, we will use 4 to be safe
...
plot(X_train, y_train, xlab = "Lag 1 Total", ylab = "Observed Total", main = "Lag 1 vs Total")
...
plot(y_pred, y_test, ylab = "Observed Totals", xlab = "Predicted Totals", main = "AR(1) Model Predictions")
abline(0, 1, col = "red")
...
```{r}
# Observed vs predicted plot
plot(y_pred, y_test, ylab = "Observed Totals", xlab = "Predicted Totals", main = "AR(4) Model Predictions")
abline(0, 1, col = "red")
